...
export const EXPERIENCE: Experience[] = [
  {
    ...
    description: [
    "Started my journey in full stack web development, building modern applications from scratch.",
      "Developed a complete social media chat platform 'Chatagram' with authentication, profiles, and messaging.",
      "Worked with multiple programming languages including JavaScript, TypeScript, Python, HTML, CSS and C#.",
      "Focused on learning clean architecture, scalable backend APIs, and modern frontend frameworks.",
    ],
    skills: [
      SkillNames.NEXTJS,
      SkillNames.TS,
  ...
  },
  {
    ...
    startDate: "Sep 2024",
    endDate: "Dec 2025",
    title: "Game Developer & Deployment Engineer",
    company: "Self-employed",
    description: [
      "Developed several games using the Unity game engine and C# programming language.",
      "Implemented gameplay systems, player mechanics, and UI interactions in real-time environments.",
      "Worked with Linux servers, Docker containers, and cloud deployment for hosting applications.",
      "Built automation workflows and managed application deployment pipelines.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.VUE,
