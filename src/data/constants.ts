...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Freelance",
    description: [
      "Built polished, minimalist web apps featuring smooth micro-interactions and Apple-esque aesthetics.",
      "Engineered real-time features using Socket.io and WebRTC, managing complex multi-network connectivity.",
      "Designed highly optimized, normalized relational database schemas with secure automated transaction controls.",
    ],
    skills: [
      SkillNames.NEXTJS,
      SkillNames.REACT,
